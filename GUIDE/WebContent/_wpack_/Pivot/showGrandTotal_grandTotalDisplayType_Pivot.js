/*amd /Pivot/showGrandTotal_grandTotalDisplayType_Pivot.xml 3427 ed321022f0fe0851cf44770a553273f368a724805a06e44aa8b008ad5364011e */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'w2:pivot',A:{style:'position: relative;padding: 20px;height:95%;width: 90%;border: 1px solid gray;left:50px;top:20px;',dataList:'data:dataList1',cols:'col2',vals:'col4,col5',autoFit:'',autoFitMinWidth:'100',showGrandTotal:'true',grandTotalName:'',grandTotalDisplayType:'both',headerListOrder:'col,row,val,hidden',allTotalName:'',totalTextAlign:'',valuesAxis:'',rows:'col1',noColumnMove:'true',id:'pivot1'},E:[{T:1,N:'w2:fieldInfo',A:{style:'padding: 10px;'},E:[{T:1,N:'w2:field',A:{id:'col1',name:'Year'}},{T:1,N:'w2:field',A:{id:'col2',name:'City'}},{T:1,N:'w2:field',A:{id:'col3',name:'Continent'}},{T:1,N:'w2:field',A:{id:'col4',name:'Expense'}},{T:1,N:'w2:field',A:{id:'col5',name:'Saving'}}]}]}]}]}]})