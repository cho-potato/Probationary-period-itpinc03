/*amd /SelectBox/setEnableColumn_SelectBox.xml 3025 a1ed6517fd844689c3629af24883306aab3b0c4fefc805c50cca538b9fe092db */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'xf:select1',A:{id:'select1',chooseOption:'',style:'width: 170px;height: 21px;margin-right: 30px;margin: 100px;',submenuSize:'auto',allOption:'',disabled:'false',direction:'auto',appearance:'minimal',disabledClass:'w2selectbox_disabled',ref:'',labelWidthAuto:'',class:'',enableColumn:'',enableColumnFalseValue:'',itemTooltipDisplay:'',tooltip:'',tooltipDisplay:'',tooltipShowAlways:'false'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dataList1'},E:[{T:1,N:'xf:label',A:{ref:'City'}},{T:1,N:'xf:value',A:{ref:'Code'}}]}]}]},{T:1,N:'xf:trigger',A:{type:'button',style:'width:125px;height:23px;line-height:25px;padding:1px;background-color:#C0C0C0;font-size:10px;font-family:monospace;font-style:normal;font-weight:bolder;margin-left:0px;',id:'trigger1','ev:onclick':'scwin.trigger1_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'setEnableColumn()'}]}]}]}]}]})