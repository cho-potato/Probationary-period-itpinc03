/*amd /SelectBox/displayMode_delimiter_SelectBox.xml 2867 2b46f271769feab227586ccc759325d62e51bb793fda33d679aa6a988dbd0529 */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'xf:select1',A:{id:'',chooseOption:'',style:'width: 148px;height: 21px;margin: 50px;',submenuSize:'auto',allOption:'',disabled:'false',direction:'auto',appearance:'minimal',disabledClass:'w2selectbox_disabled',ref:'',displayMode:'label delim value',delimiter:' - '},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dataList1'},E:[{T:1,N:'xf:label',A:{ref:'Country'}},{T:1,N:'xf:value',A:{ref:'City'}}]}]}]}]}]}]})