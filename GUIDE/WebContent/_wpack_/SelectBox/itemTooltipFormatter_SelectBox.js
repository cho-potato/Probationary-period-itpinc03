/*amd /SelectBox/itemTooltipFormatter_SelectBox.xml 3047 33c23a561fc31dfd81e267180c781bd42a9636ed6702943e1b22f6f383d594a1 */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'xf:group',A:{id:'',style:'padding-left: 200px;padding-top: 50px;'},E:[{T:1,N:'xf:select1',A:{enableColumn:'',tooltipShowAlways:'',submenuSize:'auto',useItemLocale:'',labelWidthAuto:'',chooseOption:'',tooltip:'',allOption:'',itemTooltipDisplay:'true',ref:'',appearance:'minimal',enableColumnFalseValue:'',tooltipDisplay:'',disabledClass:'w2selectbox_disabled',itemTooltipFormatter:'scwin.selectBoxTooltip',style:'width: 100px;height: 30px;',disabled:'false',id:'select1',class:'',direction:'auto',tooltipLocaleRef:''},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dataList1'},E:[{T:1,N:'xf:label',A:{ref:'City'}},{T:1,N:'xf:value',A:{ref:'Code'}}]}]}]}]}]}]}]})