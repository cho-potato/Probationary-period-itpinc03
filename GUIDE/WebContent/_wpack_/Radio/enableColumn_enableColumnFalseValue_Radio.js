/*amd /Radio/enableColumn_enableColumnFalseValue_Radio.xml 2389 b8ac61976956b7996f6fcdabfda31e6e0caf70dfaeb78c150b2bc7dec642cbee */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'xf:select1',A:{id:'',selectedIndex:'-1',appearance:'full',style:'width: 150px;height: 21px;margin: 100px;',cols:'',rows:'',ref:'',enableColumn:'Country',enableColumnFalseValue:'Germany,Canada'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dataList1'},E:[{T:1,N:'xf:label',A:{ref:'City'}},{T:1,N:'xf:value',A:{ref:'Code'}}]}]}]}]}]}]})