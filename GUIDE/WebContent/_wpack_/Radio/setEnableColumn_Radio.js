/*amd /Radio/setEnableColumn_Radio.xml 2812 de981b9eabc203fca8fda6c56013ba8341e5ec111f15c750d546f075ff869c31 */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'xf:select1',A:{id:'radio1',selectedIndex:'-1',appearance:'full',style:'width: 150px;height: 21px;margin-right: 30px;margin: 100px;',cols:'',rows:'',ref:'',enableColumn:'',enableColumnFalseValue:''},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dataList1'},E:[{T:1,N:'xf:label',A:{ref:'City'}},{T:1,N:'xf:value',A:{ref:'Code'}}]}]}]},{T:1,N:'xf:trigger',A:{type:'button',style:'width:125px;height:23px;line-height:25px;padding:1px;background-color:#C0C0C0;font-size:10px;font-family:monospace;font-style:normal;font-weight:bolder;margin-left:0px;',id:'trigger1','ev:onclick':'scwin.trigger1_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'setEnableColumn()'}]}]}]}]}]})