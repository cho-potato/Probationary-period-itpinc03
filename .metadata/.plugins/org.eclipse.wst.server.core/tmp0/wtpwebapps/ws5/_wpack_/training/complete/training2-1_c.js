...
}}}]},{T:1,N:'style',A:{type:'text/css'},E:[{T:4,cdata:'.w2radio_label:before{position:absolute;left:1px;top:5px;content:none;display:inline-block;width:20px;height:20px;border:1px solid #cfd5d8;box-sizing:border-box;border-radius:50%;background:#fff}'}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{style:'padding: 10px;',id:'',class:''},E:[{T:1,N:'w2:textbox',A:{class:'section_title',id:'',label:'이 화면은 코드를 가져오기 위한 submission을 각각(2개) 등록한 예시이다.<br/>(성별 코드, 직위 코드)',style:''}},{T:1,N:'xf:group',A:{class:'',id:'',style:'border: 1px solid gray;overflow: hidden;margin-bottom: 10px;padding: 10px 0px 0px 10px;margin-top: 10px;'},E:[{T:1,N:'xf:group',A:{style:'width:180px;float: right;margin: 0px 10px 10px 0px;text-align: right;',id:''},E:[{T:1,N:'xf:trigger',A:{'ev:onclick':'scwin.ui_btnSearch_onclick',style:'width:80px;',id:'ui_btnSearch',type:'button',class:'btn_cm sch'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'조회'}]}]},{T:1,N:'xf:trigger',A:{'ev:onclick':'scwin.ui_btnSave_onclick',id:'ui_btnSave',style:'margin-left: 10px;width:80px;',type:'button',class:'btn_cm sch'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'저장'}]}]}]},{T:1,N:'xf:group',A:{style:'width:220px;float: left;margin: 0px 10px 10px 0px;',id:'',class:''},E:[{T:1,N:'w2:span',A:{style:'',label:'성별 : ',id:''}},{T:1,N:'xf:select1',A:{selectedData:'true',submenuSize:'auto',chooseOption:'',allOption:'true',displayMode:'label',ref:'data:dc_searchParam.GENDER_CD',appearance:'minimal',disabledClass:'w2selectbox_disabled',optionOrder:'false',disabled:'false',style:'width: 148px;height: 23px;',id:'ui_search_gender',direction:'auto'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dc_code101'},E:[{T:1,N:'xf:label',A:{ref:'CODE_NM'}},{T:1,N:'xf:value',A:{ref:'CODE_CD'}}]}]}]}]},{T:1,N:'xf:group',A:{id:'',style:'width:220px;float: left;margin: 0px 10px 10px 0px;',class:''},E:[{T:1,N:'w2:span',A:{id:'',label:'직급 :',style:''}},{T:1,N:'xf:select1',A:{allOption:'true',appearance:'minimal',chooseOption:'',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',displayMode:'label',id:'ui_search_position',optionOrder:'false',ref:'data:dc_searchParam.POSITION_CD',selectedData:'true',style:'width: 148px;height: 23px;',submenuSize:'auto'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dc_code02'},E:[{T:1,N:'xf:label',A:{ref:'CODE_NM'}},{T:1,N:'xf:value',A:{ref:'CODE_CD'}}]}]}]}]}]},{T:1,N:'xf:group',A:{style:'margin-bottom: 10px;',id:'',class:'btnbox'},E:[{T:1,N:'w2:span',A:{label:'0',style:'float: right;',id:'ui_totRowCount',dataType:'number',displayFormatter:'',displayFormat:'#,##0건'}},{T:1,N:'xf:trigger',A:{type:'button',style:'float: left;margin-right: 10px;',id:'btnInsert','ev:onclick':'scwin.btnInsert_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'입력'}]}]},{T:1,N:'xf:trigger',A:{id:'btnDelete',style:'float: left;margin-right: 10px;',type:'button','ev:onclick':'scwin.btnDelete_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'삭제(delete)'}]}]},{T:1,N:'xf:trigger',A:{id:'btnRemove',style:'float: left;margin-right: 10px;',type:'button','ev:onclick':'scwin.btnRemove_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'삭제(remove)'}]}]},{T:1,N:'xf:trigger',A:{id:'btnDeleteRows',style:'float: left;margin-right: 10px;',type:'button','ev:onclick':'scwin.btnDeleteRows_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'다중삭제(deleteRows)'}]}]},{T:1,N:'xf:trigger',A:{id:'btnRemoveRows',style:'float: left;margin-right: 10px;',type:'button','ev:onclick':'scwin.btnRemoveRows_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'다중삭제(removeRows)'}]}]},{T:1,N:'xf:trigger',A:{id:'btnInit',style:'float: left;margin-right: 10px;',type:'button','ev:onclick':'scwin.btnInit_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'초기화'}]}]},{T:1,N:'xf:trigger',A:{id:'btnExcelDown',style:'float: left;margin-right: 10px;',type:'button','ev:onclick':'scwin.btnExcelDown_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'ExcelDown'}]}]},{T:1,N:'xf:trigger',A:{id:'btnExcelUp',style:'float: left;margin-right: 10px;',type:'button','ev:onclick':'scwin.btnExcelUp_onclick',class:'btn_cm'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'ExcelUp'}]}]}]},{T:1,N:'w2:gridView',A:{id:'ui_memberList',contextMenu:'true',ignoreToggleOnDisabled:'false',useShiftKey:'true',style:'height: 250px;margin-bottom: 10px;',useFilterList:'true',scrollByColumn:'false',scrollByColumnAdaptive:'false',summaryAuto:'false',fixedColumnWithHidden:'true',summaryOnlyAuto:'false',dataList:'dc_userInfoList',ignoreCellClick:'false',rowStatusVisible:'true',rowStatusWidth:'50',rowStatusHeaderValue:'상태',sortable:'true',rowNumVisible:'true',rowNumWidth:'50',backgroundColorMode:'always',rowNumHeaderValue:'NO',autoFit:'allColumn',autoFitMinWidth:'1400',visibleRowNum:'10',fastScroll:'','ev:oncellclick':'scwin.ui_memberList_oncellclick',focusMode:'row',editModeEvent:'onclick',keyMoveEditMode:'true',selectedRowColor:'#00FF40',fixedColumn:'2'},E:[{T:1,N:'w2:caption',A:{style:'',id:'caption1',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{style:'',id:'header1'},E:[{T:1,N:'w2:row',A:{style:'',id:'row1'},E:[{T:1,N:'w2:column',A:{removeBorderStyle:'false',width:'30',inputType:'checkbox',style:'',id:'column28',value:'',blockSelect:'false',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column27',blockSelect:'false',displayMode:'label',value:'사번'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column25',blockSelect:'false',displayMode:'label',value:'이름',useFilter:'true'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column23',blockSelect:'false',displayMode:'label',value:'성별'}},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'',id:'column21',blockSelect:'false',displayMode:'label',value:'입사일'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column19',blockSelect:'false',displayMode:'label',value:'직급'}},{T:1,N:'w2:column',A:{width:'171',inputType:'text',style:'',id:'column11',blockSelect:'false',displayMode:'label',value:'이메일'}},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'',id:'column9',blockSelect:'false',displayMode:'label',value:'우편번호'}},{T:1,N:'w2:column',A:{width:'148',inputType:'text',style:'',id:'column7',blockSelect:'false',displayMode:'label',value:'주소1'}},{T:1,N:'w2:column',A:{width:'138',inputType:'text',style:'',id:'column5',blockSelect:'false',displayMode:'label',value:'주소2'}}]}]},{T:1,N:'w2:gBody',A:{style:'',id:'gBody1'},E:[{T:1,N:'w2:row',A:{style:'',id:'row2'},E:[{T:1,N:'w2:column',A:{removeBorderStyle:'false',width:'30',inputType:'checkbox',style:'',id:'CHK',value:'',blockSelect:'false',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'height:28px;',id:'EMP_CD',blockSelect:'false',displayMode:'label',dataType:'number',readOnly:'true'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'height:28px;',id:'EMP_NM',blockSelect:'false',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'70',inputType:'select',style:'height:28px;',id:'GENDER_CD',blockSelect:'false',displayMode:'label',allOption:'',chooseOption:'true',viewType:'icon',customFormatter:'scwin.fnCus',chooseOptionLabel:'',ref:''},E:[{T:1,N:'w2:choices',E:[{T:1,N:'w2:itemset',A:{nodeset:'data:dc_code101'},E:[{T:1,N:'w2:label',A:{ref:'CODE_NM'}},{T:1,N:'w2:value',A:{ref:'CODE_CD'}}]}]}]},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'height:28px;',id:'JOIN_DATE',blockSelect:'false',displayMode:'label',dataType:'date',viewType:'icon'}},{T:1,N:'w2:column',A:{width:'70',inputType:'select',style:'height:28px;',id:'POSITION_CD',blockSelect:'false',displayMode:'label',allOption:'',chooseOption:'true',viewType:'icon',chooseOptionLabel:'',ref:''},E:[{T:1,N:'w2:choices',E:[{T:1,N:'w2:itemset',A:{nodeset:'data:dc_code02'},E:[{T:1,N:'w2:label',A:{ref:'CODE_NM'}},{T:1,N:'w2:value',A:{ref:'CODE_CD'}}]}]}]},{T:1,N:'w2:column',A:{width:'171',inputType:'text',style:'height:28px;',id:'EMAIL',blockSelect:'false',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'height:28px;',id:'ZIP_CD',blockSelect:'false',displayMode:'label',displayFormat:'',displayFormatter:'scwin.fnDis',customFormatter:''}},{T:1,N:'w2:column',A:{width:'148',inputType:'text',style:'height:28px;',id:'ADDRESS1',blockSelect:'false',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'138',inputType:'text',style:'height:28px;',id:'ADDRESS2',blockSelect:'false',displayMode:'label'}}]}]}]},{T:1,N:'xf:group',A:{tagname:'table',style:'width:100%;',id:'',class:'w2tb',adaptive:'layout',adaptiveThreshold:'700'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'caption'}},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{tagname:'col',style:'width:100px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}},{T:1,N:'xf:group',A:{tagname:'col',style:'width:100px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}}]},{T:1,N:'xf:group',A:{tagname:'tr',style:''},E:[{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:3,text:'이름'},{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'xf:input',A:{id:'',style:'width: 144px;height: 23px;',ref:'data:dc_userInfoList.EMP_NM'}}]},{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:3,text:'성별'},{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'xf:select1',A:{id:'ui_form_gender',selectedIndex:'0',appearance:'full',style:'min-width: 150px;min-height: 21px;',ref:'data:dc_userInfoList.GENDER_CD',rows:'1',cols:''},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dc_code101'},E:[{T:1,N:'xf:label',A:{ref:'CODE_NM'}},{T:1,N:'xf:value',A:{ref:'CODE_CD'}}]}]}]}]}]},{T:1,N:'xf:group',A:{tagname:'tr',style:''},E:[{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:3,text:'\n    					입사일\n    					'},{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'w2:inputCalendar',A:{footerDiv:'false',id:'',weekStartsOn:'0',style:'width: 150px;height: 23px;',renderDiv:'true',focusOnDateSelect:'false',calendarValueType:'yearMonthDate',rightAlign:'false',renderType:'component',ref:'data:dc_userInfoList.JOIN_DATE'}}]},{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:3,text:'\n    					직급\n    					'},{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'xf:select1',A:{allOption:'',appearance:'minimal',chooseOption:'true',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',displayMode:'label',id:'ui_form_position',optionOrder:'false',selectedData:'true',style:'width: 148px;height: 21px;',submenuSize:'auto',ref:'data:dc_userInfoList.POSITION_CD',chooseOptionLabel:''},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:dc_code02'},E:[{T:1,N:'xf:label',A:{ref:'CODE_NM'}},{T:1,N:'xf:value',A:{ref:'CODE_CD'}}]}]}]}]}]}]}]}]}]}]})