/*amd /sample/compList/main_tabControl_iframe.xml 3207 201dbb3c845447fa9350dccc3fd679b9ff806fd032de67e4b695bc55cbd7f754 */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'xf:group',A:{id:'',class:'',style:'position: relative;width: 100%;height: 100%;overflow: hidden;background: #f8f8f8;'},E:[{T:1,N:'w2:wframe',A:{id:'',scope:'false',src:'/sample/comm/wf_header.xml',style:''}},{T:1,N:'xf:group',A:{style:'position:absolute;top:60px;left:0px;right:2px;bottom:0px;',id:''},E:[{T:1,N:'w2:wframe',A:{id:'leftMenuGrp',class:'',src:'/sample/comm/wf_leftMenu.xml',style:'position: absolute;width:210px;left:0px;top:0px;bottom:0px;background:#fff;',scope:'true'}},{T:1,N:'xf:group',A:{id:'contentGrp',class:'',style:'position:absolute;left:211px;top:0px;bottom:0px;right:0px;'},E:[{T:1,N:'xf:group',A:{id:'tabCtrlGrp',style:'position:absolute;top:-31px;left:-1px;right:0px;bottom:0px;background:transparent;'},E:[{T:1,N:'w2:tabControl',A:{id:'ui_tabMain',style:'position:absolute;left:0px;right:0px;top:0px;bottom:0px;background: transparent;',class:'eduMainTab',tabScroll:'true'},E:[{T:1,N:'script',A:{type:'javascript','ev:event':'onchange(tabID,idx)'},E:[{T:4,cdata:function(scopeObj,tabID,idx){with(scopeObj){
							
}}}]}]}]}]}]}]},{T:1,N:'w2:textbox',A:{id:'',label:'TabControl - IFrame',style:'position: fixed;right: 20px;top:12px;font-weight: bold;font-size: 1.5em;'}}]}]}]})