...
.header {
	height: 27px;
	background: url(../../uiplugin/grid/upload/images/bg_header.gif)
		repeat-x left top;
}
...
.header .title {
	...
	font-weight: bold;
	line-height: 23px;
	background: url(../../uiplugin/grid/upload/images/bul_title.gif)
		no-repeat 11px 6px;
	float: left;
}
...
.header span input[type=checkbox] {
	position: relative;
	top: 1px;
}
...
.tbl th .dot {
	padding-left: 14px;
	background: url(../../uiplugin/grid/upload/images/dot.gif) no-repeat
		left center;
}

.tbl td .ipt {
	width: 74px;
	height: 16px; /*bordeR:1px solid #abadb3;*/
}
	...
	<form name="__uploadForm__" method="post" action=""
		...
		<div class="wrap">
			<div class="header">
				...
				<span id="advancedSetting"><input type="checkbox"
					onclick="check_fun();" id="subcheck" /><label for="subcheck"><p
							id="setting" class="title2">고급설정</p></label></span>
			</div>
			<div class="content">
				<div class="filebox">
					<input type="file" id="filename" name="filename" />
				</div>
				<table id="sub" class="tbl none"
					summary="공백무시,히든값유무,히든채움,푸터유무,시작Row,시작col,시트no">
					<caption id="advaned">파일 업로드 고급설정</caption>
					<tr>
						<th><label id="space_option" for="spaceSelect" class="dot">공백
								무시 :</label></th>
						<td><select name="skip_space" class="sel" id="spaceSelect">
								<option value="true">공백무시</option>
								<option value="false">공백포함</option>
						</select></td>
						<th><label id="start_option" for="gridStartRow" class="dot">시작
								Row :</label></th>
						<td><input type="text" id="gridStartRow" name="gridStartRow"
							class="ipt" /></td>
					</tr>
					<tr>
						<th><label id="hidden_option" for="hiddenSelect" class="dot">히든값유무
								:</label></th>
						<td><select name="hidden" id="hiddenSelect" class="sel">
								<option value="true">포함</option>
								<option value="false">미포함</option>
						</select></td>
						<th><label id="start_col" for="gridStartCol" class="dot">시작
								Col :</label></th>
						<td><input type="text" class="ipt" name="gridStartCol"
							id="gridStartCol" /></td>
					</tr>
					<tr>
						<th><label id="hidden_fill" for="fillHidden" class="dot">히든
								채움 :</label></th>
						<td><select name="fillHidden" id="fillHidden">
								<option value="true">채움</option>
								<option value="false">무시</option>
						</select></td>
						<th><label id="sheet_no" for="gridSheetNo" class="dot">시트
								No :</label></th>
						<td><input type="text" class="ipt" name="gridSheetNo"
							id="gridSheetNo" /></td>
					</tr>
					<tr>
						<th><label id="isHeader" for="header" class="dot">헤더
								유무 :</label></th>
						<td><select name="header" id="header">
								<option value="true">포함</option>
								<option value="false">미포함</option>
						</select></td>
						<th><label id="isFooter" for="footer" class="dot">푸터
								유무 :</label></th>
					...
					<tr>
						...
						<td colSpan="2"><input type="password" class="ipt" name="pwd"
							id="pwd" autocomplete="off" /></td>
					</tr>
				</table>
			</div>
			...
			<div class="foot">
				<p>
					<input type="button" id="sendFILE" name="sendFILE" class="btn_file"
						value="파일 업로드" onclick="return upload(this.form)" />
				</p>
		...
		<input type="hidden" id="domain" name="domain" value="" /> <input
			...
			type="hidden" id="removeColumns" name="removeColumns" value="" /> <input
			type="hidden" id="headerRows" name="headerRows" value="" /> <input
			type="hidden" id="bodyRows" name="bodyRows" value="" />
		<!-- input type="hidden" id="hidden" name="hidden" value=""/ -->
		<input type="hidden" id="delim" name="delim" value="" /> <input
			type="hidden" id="expressionColumns" name="expressionColumns"
			value="CC" /> <input type="hidden" id="gridStyle" name="gridStyle"
			value="" /> <input type="hidden" id="insertColumns"
			name="insertColumns" value="" /> <input type="hidden"
			id="gridEndCol" name="gridEndCol" value="" /> <input type="hidden"
			id="loadingMode" name="loadingMode" value="" /> <input type="hidden"
			id="optionParam" name="optionParam" value="" /> <input type="hidden"
			id="cellDataConvertor" name="cellDataConvertor" value="" /> <input
			type="hidden" id="decimal" name="decimal" value="" /> <input
			type="hidden" id="applyDecimal" name="applyDecimal" value="" /> <input
			type="hidden" id="useMaxByteLength" name="useMaxByteLength" value="" />
		<input type="hidden" id="dateFormat" name="dateFormat" value="" /> <input
			type="hidden" id="byteCheckEncoding" name="byteCheckEncoding"
			value="" /> <input type="hidden" id="columnOrder" name="columnOrder"
			value="" /> <input type="hidden" id="gridSheetName"
			name="gridSheetName" value="" /> <input type="hidden"
			id="activeSheet" name="activeSheet" value="" /> <input type="hidden"
			id="chunkNum" name="chunkNum" value="" /> <input type="hidden"
			id="trim" name="trim" value="" /> <input type="hidden"
			id="uploadType" name="uploadType" value="" />
	</form>
