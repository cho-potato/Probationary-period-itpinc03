...
<body style="background-color: #ffffff" onload="init()">
	<img style="position: absolute; left: 15px; top: 15px;"
		src="../../message/images/progressingbar.gif" />
	<br />
	<div id="textLayer"
		style="position: absolute; left: 15px; width: 150px; top: 30px; height: 15px; text-align: center;">
		데이터 수집 중.. 0%</div>
	<input id='downloadButton' type='button' disabled="true"
		style="position: absolute; right: 55px; width: 85px; top: 60px; height: 30px; text-align: center; word-wrap: break-word;"
		onclick="sendData()" value="download" />
	<input id='cancelButton' type='button'
		style="position: absolute; left: 55px; width: 85px; top: 60px; height: 30px; text-align: center; word-wrap: break-word;"
		onclick="cancle()" value="cancel" />
</body>
</html>