...
<body>
	<form name="__uploadForm__" method="post" action=""
			...
			<div class="header">
				...
				<span id="advancedSetting"><input type="checkbox"
					onclick="check_fun();" id="subcheck" /><label for="subcheck"><p
							id="setting" class="title">고급설정</p></label></span>
			</div>
			<div class="content">
				<div class="filebox">
				...
				<table id="sub" class="tbl none" summary="공백무시,히든값유무,히든채움,시작Row">
					...
					<tr>
						...
						</select--> <select name="skip_space" class="sel" id="spaceSelect">
								<option value="true">공백무시</option>
								<option value="false">공백포함</option>
						</select>
						</td>
					...
					<tr>
						<th><label id="hidden_option" for="hiddenSelect" class="dot">히든값유무
								:</label></th>
						<td><select name="hidden" class="sel" id="hiddenSelect">
					...
					<tr>
						<th><label id="header_option" for="header" class="dot">헤더유무
								:</label></th>
						<td colSpan="2"><select name="header" class="sel" id="header">
								<option value="true">포함</option>
								<option value="false">미포함</option>
						</select></td>
					</tr>
		...
		<input type="hidden" id="domain" name="domain" value="" /> <input
			...
			type="hidden" id="escapeChar" name="escapeChar" value="" /> <input
			type="hidden" id="footer" name="footer" value="" /> <input
			type="hidden" id="removeColumns" name="removeColumns" value="" /> <input
			type="hidden" id="expressionColumns" name="expressionColumns"
			value="CC" /> <input type="hidden" id="hiddenColumns"
			name="hiddenColumns" value="" /> <input type="hidden"
			id="headerRows" name="headerRows" value="" /> <input type="hidden"
			id="columnNum" name="columnNum" value="" /> <input type="hidden"
			id="bodyRows" name="bodyRows" value="" /> <input type="hidden"
			id="gridStyle" name="gridStyle" value="" /> <input type="hidden"
			id="expression" name="expression" value="" /> <input type="hidden"
			id="optionParam" name="optionParam" value="" /> <input type="hidden"
			id="columnOrder" name="columnOrder" value="" /> <input type="hidden"
			id="useXHR" name="useXHR" value="" />
	</form>
