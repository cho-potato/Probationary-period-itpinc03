...
/**
 * 공통 처리용 유틸성 기능을 제공한다. - sp5 버전 부터는 전역으로 사용하는 객체는 window를 붙여서 표현한다.
 * @type window.com
 * @class com
 * @namespace com
 */
	...
	getI18NUrl : function(url) {
		...
		if( URL.indexOf(".XML") > 0 ){
		    ...
		    if( locale == null || locale == '' ) {
		        ...
		        return "/websquare/I18N.do?w2xPath="+w2xPath;
		    } else {
		    	
		        return "/websquare/I18N.do?locale="+unescape(locale)+"&w2xPath="+w2xPath;
		    }    
		} else {
			return w2xPath;
		}
...
/**
 * Submission이후 서버에서 에러 응답이 왔을 때 실행된다.
