...
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:7,N:'xml-stylesheet',instruction:'href="/websquare5/common/css/content.css" type="text/css"'},{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:buildDate'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',E:[{T:1,N:'w2:dataList',A:{id:'dataList_menu',style:'',valueAttribute:''},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'MENU_ID',name:'메뉴ID',dataType:'text'}},{T:1,N:'w2:column',A:{id:'MENU_NM',name:'메뉴명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'HIGHER_MENU_ID',name:'상위메뉴ID',dataType:'text'}},{T:1,N:'w2:column',A:{id:'LEVEL_CNT',name:'레벨수',dataType:'text'}},{T:1,N:'w2:column',A:{id:'SRC_PATH',name:'파일경로',dataType:'text'}},{T:1,N:'w2:column',A:{id:'temp',name:'임시',dataType:'text'}}]}]}]},{T:1,N:'xf:submission',A:{id:'submission1',ref:'',target:'data:json,"dataList_menu"',action:'getMainTreeMenuData.json',method:'post',mediatype:'application/json',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'',singleMode:'true'}}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{type:'text/javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
		...
		scwin.onpageload = function() {
			...
			},
			{
				...
				"HIGHER_MENU_ID":"W5C",
				"LEVEL_CNT":4,"SRC_PATH":"/websquare5/components/DataCollection/DataListBinding.xml",
				"temp":"DataMap Binding,DataList Binding,LinkedDataList Binding"
			},
			{
				...
				"HIGHER_MENU_ID":"W5C",
				"LEVEL_CNT":5,"SRC_PATH":"/websquare5/components/DataCollection/LinkedDataListBinding.xml",
				"temp":"DataMap Binding,DataList Binding,LinkedDataList Binding"
			},
			{
				...
				"HIGHER_MENU_ID":"W5C",
				"LEVEL_CNT":6,"SRC_PATH":"/websquare5/components/DataCollection/masterDetail.xml",
				"temp":"DataMap Binding,DataList Binding,LinkedDataList Binding"
			},
			{
				"MENU_ID":"TBL",
		...
		scwin.trigger1_onclick = function(e) {
			...
			var focused_idx = gridView1.getFocusedRowIndex();																
			gridView1.setReadOnly("cell", focused_idx + 1, 0, false);
			gridView1.setFocusedCell(focused_idx + 1, 0, true);
		};
		
		
}}}]},{T:1,N:'style',A:{type:'text/css'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload'},E:[{T:1,N:'xf:group',A:{id:'group3',style:'display:table;width:100%;height:100%;'},E:[{T:1,N:'xf:group',A:{id:'group2',style:'vertical-align:middle;text-align:center;display:table-cell;'},E:[{T:1,N:'xf:group',A:{id:'group1',style:'display:inline-block;padding:30px;'},E:[{T:1,N:'xf:trigger',A:{id:'trigger1',style:'position: relative ;width: 80px;height: 23px;',type:'button','ev:onclick':'scwin.trigger1_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'행추가'}]}]},{T:1,N:'w2:textbox',A:{class:'titlebox',id:'textbox1',label:'DrillDown ',style:''}},{T:1,N:'w2:gridView',A:{id:'gridView1',dataList:'dataList_menu',rowNumHeaderValue:'',dataDragDrop:'true',style:'width:600px;height:300px;margin-left:0px;',useShiftKey:'false',scrollByColumn:'false',rowStatusVisible:'',rowStatusHeaderValue:'',rowNumVisible:'true',fixedColumnWithHidden:'',rowStatusWidth:'',visibleRowNum:'all',fixedColumn:'',autoFit:'allColumn',dragDisplayColumn:''},E:[{T:1,N:'w2:header',A:{id:'header1',style:''},E:[{T:1,N:'w2:row',A:{id:'row1',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',id:'column9',style:'height:20px;',inputType:'text',width:'187',value:'Menu.'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'column11',style:'height:20px;',inputType:'text',width:'110',value:'메뉴ID'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'column7',style:'height:20px;',inputType:'text',width:'111',value:'상위메뉴ID'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'column5',style:'height:20px;',inputType:'text',width:'45',value:'Depth',viewType:''}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'column3',style:'height:20px;',inputType:'text',width:'350',value:'FilePath.'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'column1',style:'height:20px;',width:'70',inputType:'text',value:'temp'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody1',style:''},E:[{T:1,N:'w2:row',A:{id:'row2',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',id:'MENU_NM',style:'height:20px',inputType:'drilldown',width:'187',depthColumn:'LEVEL_CNT',depthType:'div',showDepth:'2',textAlign:'left',readOnly:'true'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'MENU_ID',style:'height:20px',inputType:'text',width:'110',textAlign:'left',hidden:'true'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'HIGHER_MENU_ID',style:'height:20px',inputType:'text',width:'111',textAlign:'left',hidden:'true'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'LEVEL_CNT',style:'height:20px',inputType:'text',width:'59',textAlign:'right'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'SRC_PATH',style:'height:20px',inputType:'text',width:'351',textAlign:'left'}},{T:1,N:'w2:column',A:{blockSelect:'false',id:'temp',style:'height:20px',width:'70',inputType:'text',hidden:'true'}}]}]}]}]}]}]}]}]}]})